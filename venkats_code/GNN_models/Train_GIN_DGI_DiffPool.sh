...
#SBATCH --job-name=GIN_DGI_DiffPool_training            
...
python /home/vascul/vsayyalasomayajula/my-rdisk/r-divb/venkat/Proteomics/PlasmaAAA/GNN_models/GIN_DGI_DiffPool.py
