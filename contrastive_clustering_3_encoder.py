...
graphs = torch.load("PR80_30/proteins_graphs_400_is_observed_feature.pt.pt", weights_only=False)
### graph structure
# 6559 nodes
...
# print(g0)
# print(g0.x.shape)
# print(g0.edge_index.shape)
# print(g0.edge_attr.shape)
...
tissue_dict = {
    g.patient_id:g
    for g in tissue_graphs
}


plasma_dict = {
    g.patient_id:g
    for g in plasma_graphs
}
print(plasma_dict)
patients = sorted(
        ...
        for epoch in range(epochs):
            ...
            with torch.no_grad():
                ...
                for tissue, plasma in val_loader:
                    ...
                    tissue_proj = projector(
                        tissue_emb
                    )

                    plasma_proj = projector(
                        plasma_emb
                    )
